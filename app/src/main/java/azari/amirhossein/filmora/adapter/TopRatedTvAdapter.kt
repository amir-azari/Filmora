...
import azari.amirhossein.filmora.databinding.ItemMediaSmallBinding
...
class TopRatedTvAdapter @Inject constructor() :
    RecyclerView.Adapter<TopRatedTvAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: ItemMediaSmallBinding) :
